...
def build_train_valid_test_data_iterators(
    ...
    if mpu.get_tensor_model_parallel_rank() == 0:
        ...
        print("train_ds: {}, valid_ds: {}, test_ds: {}".format(train_ds, valid_ds, test_ds))
        ...
        print("train_dataloader: {}, valid_dataloader: {}, test_dataloader: {}".format(train_dataloader, valid_dataloader, test_dataloader))
    ...
    print("train_data_iterator: {}, valid_data_iterator: {}, test_data_iterator: {}".format(train_data_iterator, valid_data_iterator, test_data_iterator))
